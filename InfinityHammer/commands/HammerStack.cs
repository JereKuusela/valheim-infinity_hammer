...
namespace InfinityHammer {
  public class HammerStackCommand {
    ...
    public HammerStackCommand() {
      ...
      new Terminal.ConsoleCommand("hammer_stack_left", Description("left"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
      ...
      new Terminal.ConsoleCommand("hammer_stack_right", Description("right"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
      ...
      new Terminal.ConsoleCommand("hammer_stack_down", Description("down"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
      ...
      new Terminal.ConsoleCommand("hammer_stack_up", Description("up"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
      ...
      new Terminal.ConsoleCommand("hammer_stack_backward", Description("backward"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
      ...
      new Terminal.ConsoleCommand("hammer_stack_forward", Description("forward"), delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
      ...
      new Terminal.ConsoleCommand("hammer_stack", "[forward,up,right] [step=auto,auto,auto] [direction=1] - Places multiple objects next to each other.", delegate (Terminal.ConsoleEventArgs args) {
        if (args.Length < 2) {
          Helper.AddMessage(args.Context, "Error: Missing the amount.");
          return;
        }
