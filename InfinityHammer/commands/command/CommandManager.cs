...
public class CommandManager {
  ...
  public static CommandData ToData(string command) {
    ...
    CommandData data = new() {
      ...
      name = pars.Name,
      icon = pars.IconValue,
      continuous = pars.Continuous,
      initialDepth = pars.DepthCap.ToString(),
      initialHeight = pars.HeightCap.ToString(),
      initialRadius = pars.RadiusCap.ToString(),
      initialWidth = pars.WidthCap.ToString()
    };
    return data;
  }
  ...
  public static void FromFile() {
    ...
    try {
      ...
      HammerCommands = hammer.Select(FromData).ToList();
